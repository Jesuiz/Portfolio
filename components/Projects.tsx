          ...
          <div className="w-full md:w-1/2 flex flex-col gap-1 justify-center items-center text-center xlg:items-start xlg:text-left z-1">
            <div>
              <button className="h-6 px-2 border border-textPrimary font-titleFont text-[11px] text-textPrimary tracking-wider rounded-md hover:bg-hoverColor duration-300">
                  {t('project1_1')}</button>
              <h3 className="text-2xl font-bold text-textPrimary pt-1.5">
                {t('project1_2')}</h3>
            </div>
        ...
        <div className="flex flex-col md:flex-row gap-12 md:gap-6">
          ...
          <div className="w-full md:w-1/2 flex flex-col gap-1 justify-center items-center text-center xlg:items-start xlg:text-left z-1">
            ...
            <p className="w-[100%] bg-[#2f2f2f] text-sm p-4 pb-8 rounded-md">
              ...
              <div><Image
                  className="w-full h-full object-contain rounded-md -mt-6 z-10" src={ahistawa} alt="Logo de Ahistawa" />
              </div>
            </a>
          </div>
          ...
          <div className="w-full md:w-1/2 flex flex-col gap-1 justify-center items-center text-center xlg:items-start xlg:text-left z-1">
            ...
            <a className="w-[85%] h-auto relative group" href="https://www.instagram.com/p/C6zUJ96vvKl/" target="_blank">
              <div><Image
                  className="w-full h-full object-contain rounded-md -mt-6 z-10" src={macartur} alt="Logo de Ahistawa" />
              </div>
            </a>
          </div>
        </div>
