        ...
        <div className="text-balance text-center w-full text-base text-textGray flex flex-col font-semilight gap-2">
          ...
          <div className="flex flex-row items-center justify-center gap-4">
            <a href="mailto:jesuizmail@gmail.com">
              ...
              <button className="w-32 h-12 border border-textPrimary mt-6 font-titleFont text-sm text-textPrimary tracking-wider rounded-md hover:bg-hoverColor duration-300">
                {t('contact3')}
              </button>
            </a>
            <a
