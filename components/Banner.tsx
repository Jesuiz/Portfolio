...
const Banner = () => {
  ...
  return (
    <section
      id="home"
      className="max-w-contentContainer mx-auto sm:py-10 md:py-10 flex flex-col gap-4 lgl:gap-8 md:flex-row lg:items-center"
    >
      <div className="w-full md:w-2/3 flex flex-col items-center md:items-start md:text-left">
        <motion.h3
          ...
          className="lgl:text-1xl text-lg font-titleFont tracking-wide text-textGreen sm:mb-5 lgl:mb-1 text-center md:text-left"
        >
          {t('hello')}
        </motion.h3>
        ...
        <motion.p
          ...
          className="text-balance text-sm lgl:text-base lgl:mt-5 text-textGray font-semilight mb-4 lgl:mb-5 text-pretty text-center md:text-left lgl:max-w-[700px]"
      ...
      <div className="w-full md:w-1/3 flex flex-col items-center justify-center">
        <div className="relative group flex flex-col items-center md:items-stretch">
          <div className="w-full relative z-20 flex justify-center items-center lgl:mb-4">
            ...
            >
              <Image
                className="rounded-lg max-w-full sm:max-w-[200px] lgl:max-w-[500px]"
                src={profileImg}
